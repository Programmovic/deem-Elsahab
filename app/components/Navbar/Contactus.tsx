...
const Contactusform = () => {
    ...
    const handleClick = () => {
        alert(`الاسم: ${inputValues.input1}, البريد الإلكتروني: ${inputValues.input2}, الرسالة: ${inputValues.input3}`);
        setIsOpen(false);
    };
                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className="py-8 lg:py-8 px-4 mx-auto max-w-screen-md" dir="rtl">
                                        ...
                                        <p className="mb-8 lg:mb-16 mt-8 font-light text-center text-gray-500 sm:text-xl">
                                            تواصل معنا الآن! هل ترغب في إرسال ملاحظاتك؟
                                        </p>
                                        <form action="#" className="space-y-8" onSubmit={handleSubmit}>
                                            ...
                                            <button type="submit"
                                                onClick={handleClick}
                                                disabled={isDisabled}
                                                className="py-3 px-5 text-sm disabled:opacity-50 font-medium w-full text-center text-white rounded-lg bg-blue focus:ring-4 focus:outline-none focus:ring-primary-300">
                                                إرسال الرسالة
                                            </button>
                                        </form>
                                    </div>
